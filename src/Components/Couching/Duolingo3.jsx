            ...
            <div className="max-w-7xl px-4 py-8 mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4">
                     <div className="w-full flex justify-center">
                        <img
                            src="https://images.unsplash.com/photo-1713946598509-c8be7b08bf5b?q=80&w=1332&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                    ...
                    <div className="bg-white shadow rounded-lg py-4 px-4 flex flex-col items-center justify-center gap-4">
                        ...
                        <h2 className="text-2xl sm:text-3xl font-bold leading-normal text-cyan-700">
                            Your Duolingo Success Starts with the Right Plan
                        </h2>
                        {/* Subtitle */}
